...
import static com.dirtyunicorns.settings.device.actions.Constants.KEY_GESTURE_ENABLE_PROXIMITY_SENSOR;

import com.dirtyunicorns.settings.device.util.ProximityUtils;
